...
func TestNewPermission(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				subject: ID{inner: xid.ID{0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc}, label: ResourceTypeUser},
				target:  ID{inner: xid.ID{0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xc, 0xb, 0xa}, label: ResourceTypeRole},
				kind:    PermissionKindCreate,
			},
			want: Permission{
				ID:      ID{inner: xid.NilID(), label: ResourceTypePermission},
				Subject: ID{inner: xid.ID{0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc}, label: ResourceTypeUser},
				Target:  ID{inner: xid.ID{0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xc, 0xb, 0xa}, label: ResourceTypeRole},
				Kind:    PermissionKindCreate,
			},
...
func TestPermission_Validate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				ID:        ID{inner: xid.ID{0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc}, label: ResourceTypePermission},
				Kind:      PermissionKindCreate,
				Subject:   ID{inner: xid.ID{0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc}, label: ResourceTypeUser},
				Target:    ID{inner: xid.ID{0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xc, 0xb, 0xa}, label: ResourceTypeRole},
				CreatedAt: &time.Time{},
		...
		},
		{
			...
			fields: fields{
				ID:        ID{inner: xid.ID{0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc}, label: ResourceTypePermission},
				Kind:      PermissionKindCreate,
				Subject:   ID{inner: xid.NilID(), label: ResourceType(0)},
				Target:    ID{inner: xid.ID{0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xc, 0xb, 0xa}, label: ResourceTypeRole},
				CreatedAt: &time.Time{},
				UpdatedAt: &time.Time{},
			},
