...
func TestTodo_Validate(t1 *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "valid todo",
			fields: fields{
				ID:          ID{inner: xid.NilID(), label: ResourceTypeTodo},
				Title:       "title",
				Description: "description",
				Priority:    TodoPriorityNormal,
				OwnedBy:     ID{inner: xid.NilID(), label: ResourceTypeUser},
				CreatedBy:   ID{inner: xid.NilID(), label: ResourceTypeUser},
			},
		},
		{
		...
		},
		{
			...
			fields: fields{
				...
				Description: "description",
				Priority:    TodoPriorityNormal,
				OwnedBy:     ID{inner: xid.NilID(), label: ResourceType(0)},
				CreatedBy:   ID{inner: xid.NilID(), label: ResourceTypeUser},
			},
			wantErr: ErrInvalidTodoDetails,
		},
		{
			...
			fields: fields{
				...
				Priority:    TodoPriorityNormal,
				OwnedBy:     ID{inner: xid.NilID(), label: ResourceTypeUser},
				CreatedBy:   ID{inner: xid.NilID(), label: ResourceType(0)},
			},
			wantErr: ErrInvalidTodoDetails,
		},
	}
