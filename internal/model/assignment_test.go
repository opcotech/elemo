	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				user:     ID{Inner: xid.NilID(), Type: ResourceTypeUser},
				resource: ID{Inner: xid.NilID(), Type: ResourceTypeIssue},
			},
			want: &Assignment{
				ID:       ID{Inner: xid.NilID(), Type: ResourceTypeAssignment},
				Kind:     AssignmentKindAssignee,
				User:     ID{Inner: xid.NilID(), Type: ResourceTypeUser},
				Resource: ID{Inner: xid.NilID(), Type: ResourceTypeIssue},
			},
		...
		},
		{
			...
			args: args{
				kind:     AssignmentKindAssignee,
				user:     ID{Inner: xid.NilID(), Type: ResourceType(0)},
				resource: ID{Inner: xid.NilID(), Type: ResourceTypeIssue},
			},
			wantErr: ErrInvalidAssignmentDetails,
		},
		{
			...
			args: args{
				kind:     AssignmentKindAssignee,
				user:     ID{Inner: xid.NilID(), Type: ResourceTypeUser},
				resource: ID{Inner: xid.NilID(), Type: ResourceType(0)},
			},
			wantErr: ErrInvalidAssignmentDetails,
		},
	}
