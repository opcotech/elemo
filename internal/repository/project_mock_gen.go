...
func (m *MockProjectRepository) List(ctx context.Context, namespaceID, actor model.ID, scopeIDs []model.ID, page CursorPage, proj ProjectProjection) (Page[*Project], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", ctx, namespaceID, actor, scopeIDs, page, proj)
...
func (mr *MockProjectRepositoryMockRecorder) List(ctx, namespaceID, actor, scopeIDs, page, proj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockProjectRepository)(nil).List), ctx, namespaceID, actor, scopeIDs, page, proj)
}
