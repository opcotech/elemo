...
func (m *MockDocumentRepository) ListLibrary(ctx context.Context, libraryID, actor model.ID, scopeIDs []model.ID, filter LibraryListFilter, page CursorPage, proj DocumentProjection) (Page[*Document], error) {
	m.ctrl.T.Helper()
