...
//
//	mockgen -destination=mock/mock_project_gen.go -package=mocksvc . ProjectService
//
...
func (m *MockProjectService) Create(ctx context.Context, namespaceID model.ID, opts service.CreateProjectOpts) (*service.Project, error) {
	m.ctrl.T.Helper()
...
func (m *MockProjectService) Get(ctx context.Context, id model.ID) (*service.Project, error) {
	m.ctrl.T.Helper()
...
func (m *MockProjectService) List(ctx context.Context, namespaceID model.ID, page service.CursorPage) (service.Page[*service.Project], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", ctx, namespaceID, page)
	ret0, _ := ret[0].(service.Page[*service.Project])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockProjectService) Update(ctx context.Context, id model.ID, opts service.UpdateProjectOpts) (*service.Project, error) {
	m.ctrl.T.Helper()
