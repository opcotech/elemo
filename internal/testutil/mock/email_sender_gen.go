...
//
//	mockgen -source=email.go -destination=../testutil/mock/email_sender_gen.go -package=mock
//
...
func (m *MockEmailService) SendAuthPasswordResetEmail(ctx context.Context, resetPath string, user *model.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendAuthPasswordResetEmail", ctx, resetPath, user)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendAuthPasswordResetEmail indicates an expected call of SendAuthPasswordResetEmail.
func (mr *MockEmailServiceMockRecorder) SendAuthPasswordResetEmail(ctx, resetPath, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendAuthPasswordResetEmail", reflect.TypeOf((*MockEmailService)(nil).SendAuthPasswordResetEmail), ctx, resetPath, user)
}

// SendOrganizationInvitationEmail mocks base method.
func (m *MockEmailService) SendOrganizationInvitationEmail(ctx context.Context, invitationPath string, organization *model.Organization, user *model.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendOrganizationInvitationEmail", ctx, invitationPath, organization, user)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendOrganizationInvitationEmail indicates an expected call of SendOrganizationInvitationEmail.
func (mr *MockEmailServiceMockRecorder) SendOrganizationInvitationEmail(ctx, invitationPath, organization, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendOrganizationInvitationEmail", reflect.TypeOf((*MockEmailService)(nil).SendOrganizationInvitationEmail), ctx, invitationPath, organization, user)
}
