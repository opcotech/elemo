...
function ProjectDocumentsListSkeleton() {
  return (
    <Table>
      <TableHeader>
        <TableRow>
...
export function ProjectDocumentsList({
  ...
  const emptyState =
    documents.length === 0
      ? {
          ...
          description:
            "Documents will appear here when they are added to this project.",
        }
  ...
  return (
    <ListContainer
      data-section="project-documents"
      title="Documents"
