...
export const v1UsersCreateQueryKey = (options?: Options<V1UsersCreateData>) =>
  createQueryKey("v1UsersCreate", options);

/**
 * Create new user
 * Create a new user.
 */
export const v1UsersCreateOptions = (options?: Options<V1UsersCreateData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: v1UsersCreateQueryKey(options),
  });
};
...
export const v1UserResetPasswordQueryKey = (
  options?: Options<V1UserResetPasswordData>
) => createQueryKey("v1UserResetPassword", options);

/**
 * Reset user password
 * Reset the user password.
 */
export const v1UserResetPasswordOptions = (
  options?: Options<V1UserResetPasswordData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: v1UserResetPasswordQueryKey(options),
  });
};
...
export const v1TodosCreateQueryKey = (options?: Options<V1TodosCreateData>) =>
  createQueryKey("v1TodosCreate", options);

/**
 * Create todo item
 * Create a new todo item.
 */
export const v1TodosCreateOptions = (options?: Options<V1TodosCreateData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: v1TodosCreateQueryKey(options),
  });
};
...
export const v1OrganizationsCreateQueryKey = (
  options?: Options<V1OrganizationsCreateData>
) => createQueryKey("v1OrganizationsCreate", options);

/**
 * Create organization
 * Create a new organization.
 */
export const v1OrganizationsCreateOptions = (
  options?: Options<V1OrganizationsCreateData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: v1OrganizationsCreateQueryKey(options),
  });
};
...
export const v1OrganizationMembersAddQueryKey = (
  options: Options<V1OrganizationMembersAddData>
) => createQueryKey("v1OrganizationMembersAdd", options);

/**
 * Add organization member
 * Add an existing user to an organization.
 */
export const v1OrganizationMembersAddOptions = (
  options: Options<V1OrganizationMembersAddData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: v1OrganizationMembersAddQueryKey(options),
  });
};
...
export const v1OrganizationRolesCreateQueryKey = (
  options: Options<V1OrganizationRolesCreateData>
) => createQueryKey("v1OrganizationRolesCreate", options);

/**
 * Create a new role in the organization
 * Create a new role and assign it to the organization.
 */
export const v1OrganizationRolesCreateOptions = (
  options: Options<V1OrganizationRolesCreateData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: v1OrganizationRolesCreateQueryKey(options),
  });
};
...
export const v1OrganizationRoleMembersAddQueryKey = (
  options: Options<V1OrganizationRoleMembersAddData>
) => createQueryKey("v1OrganizationRoleMembersAdd", options);

/**
 * Add organization role member
 * Add an existing user to an organization's role.
 */
export const v1OrganizationRoleMembersAddOptions = (
  options: Options<V1OrganizationRoleMembersAddData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: v1OrganizationRoleMembersAddQueryKey(options),
  });
};
...
export const v1PermissionsCreateQueryKey = (
  options?: Options<V1PermissionsCreateData>
) => createQueryKey("v1PermissionsCreate", options);

/**
 * Create permission
 * Create a new permission for a subject to the given target.
 */
export const v1PermissionsCreateOptions = (
  options?: Options<V1PermissionsCreateData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: v1PermissionsCreateQueryKey(options),
  });
};
