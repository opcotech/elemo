...
export class TodoService {
   ...
   * @throws ApiError
   */
  public static v1TodosGet(offset?: number, limit: number = 100, completed?: boolean): CancelablePromise<Array<Todo>> {
   ...
   * @throws ApiError
   */
  public static v1TodosCreate(requestBody?: {
    /**
   ...
   * @throws ApiError
   */
  public static v1TodoGet(id: string): CancelablePromise<Todo> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/v1/todos/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static v1TodoDelete(id: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/v1/todos/{id}',
      path: {
