...
export class OrganizationService {
   ...
   * @throws ApiError
   */
  public static v1OrganizationMemberRemove(id: string, userId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public static v1OrganizationRoleGet(id: string, roleId: string): CancelablePromise<Role> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static v1OrganizationRoleDelete(id: string, roleId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/v1/organizations/${id}/roles/{role_id}',
      path: {
   ...
   * @throws ApiError
   */
  public static v1OrganizationRoleMembersGet(id: string, roleId: string): CancelablePromise<Array<User>> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static v1OrganizationRoleMemberRemove(id: string, roleId: string, userId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
