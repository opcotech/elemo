  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(buttonVariants({ variant: 'ghost' }), 'h-7 w-7 p-0 opacity-50 hover:opacity-100'),
        ...
        day_today: 'bg-accent/30 text-foreground aria-selected:bg-primary aria-selected:text-primary-foreground',
        day_outside:
          'day-outside text-[#757575] dark:text-muted-foreground aria-selected:bg-primary/80 aria-selected:text-primary-foreground aria-selected:opacity-90',
        day_disabled: 'text-[#757575]',
