...
|:-------------|:-----------|------------|:------------|
| @gabor-boros | 2025-08-10 | 2026-08-19 | superseded  |

Superseded by
[Scoped Relationship-Based Authorization](0021.scoped-rebac-authorization.md).
Loaders and `usePermissions` remain the fetch path; checks must use exact
action strings and must not treat `*` as allow-all.
