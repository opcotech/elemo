...
|:-------------|:-----------|------------|:------------|
| @gabor-boros | 2023-04-24 | 2026-08-19 | superseded  |

Superseded for **authorization** by
[Scoped Relationship-Based Authorization](0021.scoped-rebac-authorization.md).
OAuth2 authentication and Redis session storage described here remain in
effect until a later ADR replaces them.
